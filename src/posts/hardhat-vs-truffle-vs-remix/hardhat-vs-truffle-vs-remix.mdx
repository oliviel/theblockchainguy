...
This article is a comparasion between Hardhat, Truffle and Remix, focusing on their characteristics and ecosystem to be able to make a decision of which library to use for your particular use case.

<h2 className="text-2xl md:text-3xl font-bold flex items-center">
  <img className="w-8 mr-2" src={hardhatIcon} alt="hardhat icon" /> What is
  Hardhat?
</h2>
...
<h2 className="text-2xl md:text-3xl font-bold flex items-center">
  <img className="w-9 mr-2" src={remixIcon} alt="remix icon" />
  What is Remix?
</h2>
...
Truffle comes with a suite of testing libraries to make testing easier out of the box, the fisrt way to test your smart contracts is with javascript and typescript. Truffle comes with Mocha, Chai and Web3.js to write javascript tests.
...
<div className="flex items-center">
  <img className="w-8 mr-2 inline-block" src={truffleIcon} alt="truffle icon" />
  <span className="text-xl md:text-3xl font-bold">
...
<h2 className="text-2xl md:text-3xl font-bold flex items-center">
  <img className="w-8 mr-2" src={hardhatIcon} alt="hardhat icon" />
  <img className="w-8 mx-2" src={truffleIcon} alt="truffle icon" />
  <img className="w-8 mx-2" src={remixIcon} alt="remix icon" />
  Popularity
</h2>
...
If you ask me, my opinion is you can start with Remix because you don't even have to deal with installing dependencies in your local and you can start without so much trouble coding and learn the basics of solidity, testing, and deployment to test net even mainnets.
